 ...
 */
public class MyFindFragmentAdapter extends RecyclerView.Adapter<MyFindFragmentAdapter.ViewHolder>{

    private final List<Lost> lostList;
    private final MyFindFragment.MyFindFragmentListener mListener;

    public MyFindFragmentAdapter(List<Lost> lostList, MyFindFragment.MyFindFragmentListener mListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.onMyFindFragmentInteraction(holder.baseObject);
            }
        });
